...
\end{equation}
or, if we denote $\mu = \cost$\nomenclature[g]{$\mu$}{cosine of the polar component of the direction vector
$\bomega$}\index{$\mu$} the cosine of the polar component of the direction vector $\bomega$ (see \fref{fig:scatter}),
$$
...
\begin{figure}[!hbt]
    \centering
    \includegraphics[scale=1.25]{scattering}
