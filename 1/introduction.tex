...
\myparagraph{Numerical modelling of neutron transport}
...
harmonics of order $N$} -- which is the subject of the second part of Chap. \ref{chap:mcpn}\footnote{So far, however,
